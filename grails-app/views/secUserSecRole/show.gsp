			...
			<ol class="property-list secUserSecRole">
				...
				<li class="fieldcontain">
					<span id="secUser-label" class="property-label"><g:message code="secUserSecRole.secUser.label" default="Sec User" /></span>
						...
						<span class="property-value" aria-labelledby="secUser-label"><g:link controller="user" action="show" id="${secUserSecRoleInstance?.secUser?.id}">${secUserSecRoleInstance?.secUser?.encodeAsHTML()}</g:link></span>
